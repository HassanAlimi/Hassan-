...
def Inser_Value_To_action(date_created, id_contact, user_id, plateform=str("Instagram"),):
    try:
        ...
        action_tuple = (
            ...
            str(datetime.now().strftime("%Y-%m-%d %H:%M:%S")), user_id,insta_username, )
...
def Inser_Value_To_contact(user_id, name, plateform=str("Instagram")):
    ...
    try:
        ...
        conn.close()
        return store_action(date_created, contact_id, user_id)
    except Exception as ex:
        ...
        try:
            ...
            for button in buttons:
                if button not in followButton:
                    ...
                    name = name[1:]
                    Inser_Value_To_action(p_taskuser_id, name)
                    action_done += 1
